                  ...
                  child: Column(
                    ...
                    children: [
                      textBodyMedium(
                          ...
                          color: Colors.black),
                      textBodySmall(
                          storeController.listStorePots[index].description ??
                              '',
                          color: Colors.black),
                      textBodySmall(
                ...
                FxButton.outlined(
                  onPressed: () async {
                    if (storeController.getStringLockLevel(
                            storeController.listStorePots[index].levelUnlock ??
                                1) !=
                        null) return;
                    ...
                    children: [
                      if (storeController.getStringLockLevel(storeController
                        ...
                        Container(
                          ...
                          child: Image.asset(
                            storeController.listStorePots[index].currencyUnit ==
                                    'oxygen'
                      ...
                      textTitleMedium(
                          storeController.getStringLockLevel(storeController
                                      .listStorePots[index].levelUnlock ??
                                  1) ??
                              storeController.listStorePots[index].priceStore
                                  ?.toString() ??
                              '',
                          color: Colors.black)
                    ],
                  ...
                  child: Column(
                    ...
                    children: [
                      textBodyMedium(listPlantsData[index].name ?? '',
                          color: Colors.black),
                      textBodySmall(listPlantsData[index].description ?? '',
                          color: Colors.black),
                      textBodySmall(
                    ...
                    children: [
                      if (storeController.getStringLockLevel(storeController
                        ...
                        Container(
                          ...
                          child: Image.asset(
                            storeController
                                        .listStorePlants[index].currencyUnit ==
                                    'oxygen'
                                ? 'assets/images/oxygen.png'
                                : storeController.listStorePlants[index]
                                            .currencyUnit ==
                      ...
                      textTitleMedium(
                          storeController.getStringLockLevel(storeController
                                      .listStorePlants[index].levelUnlock ??
                                  1) ??
                              storeController.listStorePlants[index].priceStore
                                  ?.toString() ??
                              '',
                          color: Colors.black)
                    ],
              ...
              children: [
                Expanded(
                    ...
                    child: Container(
                      ...
                      padding: const EdgeInsets.all(8.0),
                      child: imageNetwork(
                        url: storeController.listStoreItems[index].image ?? '',
                        fit: BoxFit.contain,
                      ),
                    )),
                Expanded(
                  ...
                  child: Column(
                    ...
                    children: [
                      textBodyMedium(
                          ...
                          color: Colors.black),
                      textBodySmall(
                          storeController.listStoreItems[index].description ??
                              '',
                          color: Colors.black),
                      // textBodySmall(
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        ...
                        padding: const EdgeInsets.symmetric(horizontal: 4),
                        child: Image.asset(
                          storeController.listStoreItems[index].currencyUnit ==
                                  'oxygen'
                              ? 'assets/images/oxygen.png'
                              : storeController
                                          .listStoreItems[index].currencyUnit ==
                                      'ticket'
                                  ? 'assets/images/ticket.png'
                                  : 'assets/images/gemstone.png',
                          fit: BoxFit.cover,
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      textBodyMedium(storeController.products[index].title,
                          color: Colors.black),
                ...
                FxButton.outlined(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      //   ),
                      // ),
                      textTitleMedium(storeController.products[index].price,
                          color: Colors.black)
                    ],
                  ),
                ),
