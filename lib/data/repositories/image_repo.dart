...
//   Future<String?> uploadImageDiscord(File file) async {
//     try {
...
//       buildToast(message: 'Lỗi tải ảnh', status: TypeToast.toastDefault);
//       return null;
//     }
//   }

//   Future<String?> uploadFileDiscord(File file) async {
//     try {
//       var uploadImageResult = await discordClient.uploadImage(
//         image: DiscordUploadableImage(
//           bytes: file.readAsBytesSync(),
