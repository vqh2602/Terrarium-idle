...
class $AssetsAudiosGen {
  ...
  /// File path: assets/audios/level_up.mp3
  String get levelUp => 'assets/audios/level_up.mp3';

  /// File path: assets/audios/like.mp3
  String get like => 'assets/audios/like.mp3';

  /// File path: assets/audios/m1.mp3
  String get m1 => 'assets/audios/m1.mp3';

  /// File path: assets/audios/m2.mp3
  String get m2 => 'assets/audios/m2.mp3';
  ...
  /// File path: assets/audios/rain.mp3
  String get rain => 'assets/audios/rain.mp3';

  /// File path: assets/audios/tap.mp3
  String get tap => 'assets/audios/tap.mp3';
...
class $AssetsImagesGen {
  ...
  AssetGenImage get infoPlant =>
      const AssetGenImage('assets/images/info_plant.png');

  /// File path: assets/images/oxygen.png
  AssetGenImage get oxygen => const AssetGenImage('assets/images/oxygen.png');
  ...
  /// File path: assets/images/sell.png
  AssetGenImage get sell => const AssetGenImage('assets/images/sell.png');

  /// File path: assets/images/shovel.png
  AssetGenImage get shovel => const AssetGenImage('assets/images/shovel.png');
...
class $AssetsLogoGen {
  ...
  AssetGenImage get logoJpg => const AssetGenImage('assets/logo/logo.jpg');
...
class $AssetsRiveOverlayGen {
  const $AssetsRiveOverlayGen();

  /// File path: assets/rive/overlay/cloud_icon.riv
  String get cloudIcon => 'assets/rive/overlay/cloud_icon.riv';

  /// File path: assets/rive/overlay/light_like.riv
  String get lightLike => 'assets/rive/overlay/light_like.riv';

  /// File path: assets/rive/overlay/overlay1.riv
  String get overlay1 => 'assets/rive/overlay/overlay1.riv';

  /// File path: assets/rive/overlay/overlay2.riv
  String get overlay2 => 'assets/rive/overlay/overlay2.riv';
