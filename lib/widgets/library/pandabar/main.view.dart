import 'package:terrarium_idle/widgets/library/pandabar/fab-button.view.dart';
import 'package:terrarium_idle/widgets/library/pandabar/pandabar.dart';
              ...
              child: Builder(builder: (context) {
                ...
                widget.buttonData.asMap().forEach((i, data) {
                  Widget btn = PandaBarButton(
                    icon: data.icon,
                    title: data.title,
                    isSelected: data.id != null && selectedId == i,
